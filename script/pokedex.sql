...
--
-- Host: 127.0.0.1
-- Generation Time: May 15, 2023 at 04:18 AM
...
INSERT INTO `tipo_pokemon` (`id`, `descripcion`, `image`) VALUES
                                                              (1, 'Agua', 'imgs/tipo_agua.png'),
                                                              (2, 'Fuego', 'imgs/tipo_fuego.png'),
                                                              (3, 'Electrico', 'imgs/tipo_electrico.png'),
                                                              (4, 'Psiquico', 'imgs/tipo_psiquico.png'),
                                                              (5, 'Tierra', 'imgs/tipo_tierra.png');
